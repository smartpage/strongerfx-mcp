...
def convert(spec):
    ...
    purposes={'interface':'UI button click tap app tutorial text reveal','impacts':'hit thud punch cut object foley','footsteps':'walk movement scene foley','glitches':'error glitch digital disruption transition','notifications':'success notification reveal confirm','transitions':'transition cinematic reveal motion sweep'}
